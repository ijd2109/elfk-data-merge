...
q2 <- read.csv("/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_BDI_Questionnaire_original.csv") 
q3 <- read.csv("/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_Caregiving_Questionnaire.csv")
q4 <- read.csv("/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_CRPR_Questionnaire.csv")
q5 <- read.csv("/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_GRIT_Questionnaire.csv")
q6 <- read.csv("/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_Parent_STAI_Questionnaire.csv")
...
nrow(df_merged20)
df_merged21<- df_merged20
names(df_merged21) <- gsub( ".x",  "", names(df_merged22), fixed = TRUE)
names(df_merged21) <- gsub( ".y",  "", names(df_merged22), fixed = TRUE)
names(df_merged21)

#Save output
write.csv(df_merged21, "/Volumes/danl/ELFK/Data_Entry/Questionnaires/R_Cleaning_Qualtrics_Data/QUALTRICS_CLEANED_IN_R/ELFK_Qualtrics_merged_r_Nov_15_2018.csv", row.names =  FALSE)
