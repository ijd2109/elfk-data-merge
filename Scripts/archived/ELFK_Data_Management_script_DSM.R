...
DSM_Q <- read.csv("QUALTRICS_RAW_FOR_R/Qualtrics_RAW_DSM_Questionnaire.csv")
#view
head(DSM_Q)
names(DSM_Q)
nrow(DSM_Q)
...
DSM_Q.3$KSADS_DSM1_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM1_child_report))
DSM_Q.3$KSADS_DSM2_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM2_child_report))
DSM_Q.3$KSADS_DSM3_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM3_child_report))
DSM_Q.3$KSADS_DSM4_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM4_child_report))
DSM_Q.3$KSADS_DSM5_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM5_child_report))
DSM_Q.3$KSADS_DSM6_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM6_child_report))
DSM_Q.3$KSADS_DSM7_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM7_child_report))
DSM_Q.3$KSADS_DSM8_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM8_child_report))
DSM_Q.3$KSADS_DSM9_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM9_child_report))
DSM_Q.3$KSADS_DSM10_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM10_child_report))
DSM_Q.3$KSADS_DSM11_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM11_child_report))
DSM_Q.3$KSADS_DSM12_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM12_child_report))
DSM_Q.3$KSADS_DSM13_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM13_child_report))
DSM_Q.3$KSADS_DSM14_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM14_child_report))
DSM_Q.3$KSADS_DSM15_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM15_child_report))
DSM_Q.3$KSADS_DSM16_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM16_child_report))
DSM_Q.3$KSADS_DSM17_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM17_child_report))
DSM_Q.3$KSADS_DSM18_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM18_child_report))
DSM_Q.3$KSADS_DSM19_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM19_child_report))
DSM_Q.3$KSADS_DSM20_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM20_child_report))
DSM_Q.3$KSADS_DSM21_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM21_child_report))
DSM_Q.3$KSADS_DSM22_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM22_child_report))
DSM_Q.3$KSADS_DSM23_child_report <- as.numeric(as.character(DSM_Q.3$KSADS_DSM23_child_report))
...
write.csv(DSM_Q.4, "QUALTRICS_CLEANED_IN_R/Qualtrics_Cleaned_in_R_DSM_Questionnaire.csv", row.names = FALSE)